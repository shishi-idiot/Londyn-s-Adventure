...
class ApplicationMain
{
	...
	{
		lime.system.System.__registerEntryPoint("Londyn's Adventure", create);

		#if (js && html5)
		#if (munit || utest)
		lime.system.System.embed("Londyn's Adventure", null, 1280, 720);
		#end
		#else
		create(null);
		#end
	...
	public static function create(config):Void
	{
		...
		app.meta["file"] = "Londyn's Adventure";
		app.meta["name"] = "Londyn's Adventure Demo";
