...
HXLINE(  18)		::lime::_hx_system::System_obj::_hx___registerEntryPoint(HX_("Londyn's Adventure",aa,64,6e,0b),::ApplicationMain_obj::create_dyn());
...
HXLINE(  37)		app->meta->set(HX_("file",7c,ce,bb,43),HX_("Londyn's Adventure",aa,64,6e,0b));
HXLINE(  38)		app->meta->set(HX_("name",4b,72,ff,48),HX_("Londyn's Adventure Demo",79,88,a4,08));
...
HXLINE(  46)		 ::Dynamic attributes =  ::Dynamic(::hx::Anon_obj::Create(16)
            			...
            			->setFixed(9,HX_("title",98,15,3b,10),HX_("Londyn's Adventure Demo",79,88,a4,08))
